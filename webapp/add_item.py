...
with app.app_context():
    ...
    new_record7 = electro(t1=6080, t2=3149, tarif1=6.8, tarif2=2.61, date='11/20', summ=14290)
    new_record8 = electro(t1=7382, t2=3791, tarif1=6.8, tarif2=2.61, date='12/20', summ=10529)
    new_record9 = electro(t1=9926, t2=5103, tarif1=6.8, tarif2=2.61, date='01/21', summ=21035)
